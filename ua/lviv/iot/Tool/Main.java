...
public class Main {
	...
	public static void main(String[] args) {
		...
		Screwdriver screwdriver = new Screwdriver("Flash", 220, Function.CUTTING, "Germany", 1000, FurnitureType.WOODEN, 300);
		PressMachine pressmachine = new PressMachine("Hulk", 210, "Italy", Function.FASTENING, 1500, FurnitureType.IRON, 200);
		HammerMachine hammerMachine = new HammerMachine("Smasher", 250, Function.SHAPING, "Ukraine", 900,FurnitureType.IRON, 500, 60);
